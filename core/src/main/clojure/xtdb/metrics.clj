...
(defmulti ->meter-registry-factory
...
(defmethod ->meter-registry-factory :in-memory [_ _opts] (PrometheusMeterRegistry. PrometheusConfig/DEFAULT))
(defmethod ->meter-registry-factory :cloudwatch [_ opts] (->meter-registry-factory :xtdb.metrics.cloudwatch/meter-registry opts))
